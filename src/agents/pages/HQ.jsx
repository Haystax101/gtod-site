      ...
      {rows.map((a) => (
        <div key={a._id} className={`roster-row${a.status === 'removed' ? ' removed' : ''}`}>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div className="m" style={{ color: a.universityId === 'other' ? 'var(--amber)' : undefined }}>{a.yearLabel}{a.university ? ` · ${a.universityId === 'other' ? `Not in list: ${a.university}` : a.university}` : ''}</div>
          </div>
          {a._id === me._id ? (
